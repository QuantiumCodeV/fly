...
<head>
  ...
  <title>Our Accreditations | Luxury Airways</title>
  <style>
  ...
  <meta name="description"
    content="Specializing in Discounted Business Class Tickets, we ensure your comfort with smart financial choices. For Cheap Business Class Flights, we've got you covered.">
    ...
    <div>
      <header class="w-full pl-[calc(100vw-100%)] transition-colors duration-500 absolute h-20 md:h-32 z-50 text-black">
        <div class="container flex items-center justify-between h-full"><a href="/" class=""><img src="/logo.png" alt=""
          ...
          <div class="flex items-center gap-6"><a
              class="text-white relative max-sm:hidden px-5 py-2 bg-brand border-2 border-brand-300 rounded-full leading-none"
              href="tel:+18776571177"><span class="text-sm font-bold">FREE PHONE-ONLY DEALS</span><span
                class="flex items-center gap-1"><span class="iconify i-ic:baseline-phone" aria-hidden="true"
                  style=""></span><span class="text-xs font-medium">Call 24/7: +1 (315) 260-2111</span></span>
              <div
                class="absolute top-1/2 left-1/2 w-2/3 h-full -translate-x-1/2 -translate-y-1/2 before:absolute before:inset-0 before:rounded-full before:bg-brand before:animate-ping -z-10">
              </div>
            </a><!--[--><button type="button" aria-haspopup="dialog" aria-expanded="false" data-state="closed"
              class=""><!--[--><span class="iconify i-jam:menu text-4xl" aria-hidden="true"
                style=""></span><!--]--></button><!----><!--]--></div>
        </div>
      </header>
      <main class="[--header-height:5rem] md:[--header-height:8rem]"><!--[-->
        <section class="pb-10 lg:pb-16 pt-10 lg:pt-16 bg-white odd:bg-[#f0ece3] group !pt-[--header-height]"
          data-v-0d11afb1><!---->
          <div class="content container bg-white shadow rounded-xl p-6" data-v-0d11afb1=""><!--[-->
            <h1 data-v-0d11afb1-s="">Our Accreditations:</h1>
            <p data-v-0d11afb1-s=""> Is Luxury Airways legit? At Luxury Airways, we prioritize trust and transparency in
              the travel industry, offering a range of premium services such as business class and first class flights
              at the lowest fares available. We are committed to providing a luxurious and comfortable business class
              experience, ensuring our customers receive high-quality service and dedicated customer support when
              booking affordable business class flights. Our focus on legitimacy and credibility makes us the preferred
              choice for those seeking elevated travel experiences. </p>
            <p data-v-0d11afb1-s=""><strong data-v-0d11afb1-s="">TRUE Code: 99931160.</strong> Luxury Airways holds a
              TRUE (Travel Retailer Universal Enumeration) Code with the accreditation number 99931160. This
              accreditation, issued by the International Air Transport Association (IATA), signifies our dedication to
              upholding industry standards and best practices, guaranteeing excellence in travel services, including
              exclusive business class ticket deals. You can verify our CCRA Accredited Travel Agency's TRUE Code on the
              official website: <a href="https://www.ccra.com/check-true-code/" target="_blank"
                data-v-0d11afb1-s="">Verify TRUE Code</a></p>
            <p data-v-0d11afb1-s=""><strong data-v-0d11afb1-s="">PCI Compliance.</strong> We are dedicated to ensuring
              the highest level of security for our customers. Luxury Airways is PCI (Payment Card Industry) compliant,
              adhering to stringent security standards to protect your payment information during transactions. This
              compliance underscores our commitment to your data security and privacy. </p>
            <p data-v-0d11afb1-s=""><strong data-v-0d11afb1-s="">BBB A+ Rating.</strong> Luxury Airways is proud to hold
              an A+ rating from the Better Business Bureau (BBB), reflecting our dedication to resolving customer
              concerns promptly and maintaining the highest level of customer satisfaction. The BBB rating is a
              testament to our commitment to integrity, performance, and trustworthiness in all our business dealings.
              You can verify our BBB rating by visiting the official BBB website: Verify BBB Rating. </p>
            <p data-v-0d11afb1-s=""> Our TRUE, BBB, and PCI compliance accreditations require strict adherence to
              industry regulations, financial stability, and an unwavering commitment to customer satisfaction. These
              accreditations assure our customers that they are dealing with a legitimate and highly reputable travel
              agency with the highest standards of data security. Our dedication to excellence is further reflected in
              our exclusive offerings, including discount business class tickets, enticing business class deals, and
              budget-friendly cheap business flights. Rest assured, our industry-recognized accreditations validate our
              commitment to the highest standards of data security, ensuring your peace of mind and privacy throughout
              your journey. </p>
            <p data-v-0d11afb1-s=""> We also invite you to read the reviews from over 100 customers on <a
                href="https://www.trustpilot.com/review/fly.business" target="_blank"
                data-v-0d11afb1-s="">Trustpilot</a>. Their experiences reflect our commitment to excellence and our
              dedication to being a trusted and reputable choice for your travel needs. </p><img
              src="/_nuxt/securitymetrics.B42UxJNQ.png" alt="security metrics image" width="1942" height="1478"
              loading="lazy" class="mx-auto mt-6" data-v-0d11afb1-s=""><!--]-->
          </div>
        </section><!--]-->
      </main>
      <footer class="flex flex-col gap-6 pt-10 bg-[#f0ece3]">
        <div class="container flex gap-6 max-xl:flex-col">
          <div class="flex gap-6 flex-col shrink-0">
            <div class="flex items-center justify-between gap-1 p-3 bg-white"><a href="/" class=""><img src="/logo.png"
                  alt="" class="w-full object-cover max-sm:hidden" width="10rem" style="max-width: 160px;"></a>
              <div class="relative isolate mb-1.5 mr-1.5 group"><span aria-hidden="true"
                  class="absolute top-1.5 left-1.5 w-full h-full rounded border-2 border-brand-100 -z-10 group-hover:top-0 group-hover:left-0 transition-all pointer-events-none"></span><a
                  href="tel:+18776571177"
                  class="flex flex-col items-center px-3 py-1 text-sm tracking-wider bg-brand hover:bg-brand-700 transition-colors text-white rounded"><span
                    class="font-bold">FREE PHONE-ONLY DEALS</span><span>+1 (315) 260-2111</span></a></div>
            </div>
            <div class="flex max-sm:flex-col max-sm:items-center justify-between gap-2">
              <div class="flex flex-col">
                <div>Follow us on Social Media:</div>
                <div class="flex max-sm:justify-center gap-2 text-2xl"><a target="_blank"
                    href="https://www.instagram.com/flybusiness360" aria-label="Luxury Airways Instagram page"
                    class="hover:text-brand"><span class="iconify i-simple-icons:instagram" aria-hidden="true"
                      style=""></span></a><a target="_blank" href="https://www.facebook.com/flybusiness360"
                    aria-label="Luxury Airways Facebook page" class="hover:text-brand"><span
                      class="iconify i-simple-icons:facebook" aria-hidden="true" style=""></span></a></div>
              </div>
              <div class="flex flex-col max-sm:items-center">
                <div>Customer Service</div>
                <div class="flex max-sm:gap-3 sm:gap-2 text-brand"><a href="tel:+18775133776"
                    class="group relative isolate w-fit pointer-events-none">+1 (315) 260-2111 <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="cdn-cgi/l/email-protection.html#8be8f8cbede7f2a5e9fef8e2e5eef8f8"
                    class="group relative isolate w-fit pointer-events-none"><span class="__cf_email__"
                      data-cfemail="c1a2b281a7adb8efa3b4b2a8afa4b2b2">[email&#160;protected]</span> <span
                      aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a>
                </div>
              </div>
            </div><!--[-->
            <nav class="max-md:hidden grid grid-cols-4 gap-5"><!--[-->
              <div class="flex flex-col gap-2.5">
                ...
                <div class="flex flex-col gap-2"><!--[--><a href="business-class/europe.html"
                    class="group relative isolate w-fit pointer-events-none">Europe <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/asia.html" class="group relative isolate w-fit pointer-events-none">Asia <span
                      aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/africa.html" class="group relative isolate w-fit pointer-events-none">Africa
                    <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/oceania.html" class="group relative isolate w-fit pointer-events-none">Oceania
                    <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/middle-east.html"
                    class="group relative isolate w-fit pointer-events-none">Middle East <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/latin-america.html"
                    class="group relative isolate w-fit pointer-events-none">Latin America <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/indian-subcontinent.html"
                    class="group relative isolate w-fit pointer-events-none">Indian Subcontinent <span
                      aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]-->
                </div>
              </div>
              <div class="flex flex-col gap-2.5">
                ...
                <div class="flex flex-col gap-2"><!--[--><a href="business-class/europe/united-kingdom.html"
                    class="group relative isolate w-fit pointer-events-none">United Kingdom <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/asia/japan.html" class="group relative isolate w-fit pointer-events-none">Japan
                    <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/africa/tanzania.html"
                    class="group relative isolate w-fit pointer-events-none">Tanzania <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/oceania/new-zealand.html"
                    class="group relative isolate w-fit pointer-events-none">New Zealand <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/middle-east/qatar.html"
                    class="group relative isolate w-fit pointer-events-none">Qatar <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/latin-america/brazil.html"
                    class="group relative isolate w-fit pointer-events-none">Brazil <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/indian-subcontinent/maldives.html"
                    class="group relative isolate w-fit pointer-events-none">Maldives <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]-->
                </div>
              </div>
              <div class="flex flex-col gap-2.5">
                <div class="text-lg uppercase font-semibold">Top Cities</div>
                <div class="flex flex-col gap-2"><!--[--><a href="business-class/europe/france/paris.html"
                    class="group relative isolate w-fit pointer-events-none">Paris <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/asia/china/beijing.html"
                    class="group relative isolate w-fit pointer-events-none">Beijing <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/africa/south-africa/cape-town.html"
                    class="group relative isolate w-fit pointer-events-none">Cape Town <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/oceania/australia/sydney.html"
                    class="group relative isolate w-fit pointer-events-none">Sydney <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/middle-east/united-arab-emirates/dubai.html"
                    class="group relative isolate w-fit pointer-events-none">Dubai <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/latin-america/argentina/buenos-aires.html"
                    class="group relative isolate w-fit pointer-events-none">Buenos Aires <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="business-class/asia/south-korea/seoul.html"
                    class="group relative isolate w-fit pointer-events-none">Seoul <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]-->
                </div>
              </div>
              <div class="flex flex-col gap-2.5">
                <div class="text-lg uppercase font-semibold">Top Airlines</div>
                <div class="flex flex-col gap-2"><!--[--><a href="airlines/american-airlines.html"
                    class="group relative isolate w-fit pointer-events-none">American Airlines <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="airlines/turkish-airlines.html"
                    class="group relative isolate w-fit pointer-events-none">Turkish Airlines <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="airlines/united-airlines.html" class="group relative isolate w-fit pointer-events-none">United
                    Airlines <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="airlines/delta-airlines.html" class="group relative isolate w-fit pointer-events-none">Delta
                    Air Lines <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="airlines/qatar-airways.html" class="group relative isolate w-fit pointer-events-none">Qatar
                    Airways <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="airlines/lufthansa.html" class="group relative isolate w-fit pointer-events-none">Lufthansa
                    <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                    href="airlines/emirates.html" class="group relative isolate w-fit pointer-events-none">Emirates
                    <span aria-hidden="true"
                      class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]-->
                </div>
              </div><!--]-->
          ...
          <div class="flex flex-col gap-3">
            ...
            <div class="flex flex-wrap items-center justify-center gap-3 text-gray-300 my-auto"><svg
              ...
              </svg><svg xmlns="http://www.w3.org/2000/svg" width="61" height="23" viewbox="0 0 61 23" style="color:black">
                <path
                  d="M12.3419 22.3097V12.8898H22.3111L23.3806 14.2848L24.4856 12.8898L60.6712 12.8898V21.6601C60.6712 21.6601 59.7249 22.3003 58.6304 22.3097H38.5937L37.3878 20.8248V22.3097H33.4361V19.7749C33.4361 19.7749 32.8963 20.1287 31.7293 20.1287H30.3842V22.3097H24.401L23.333 20.8848L22.2485 22.3097H12.3419Z"
                  fill="black"></path>
                <path
                  d="M0.700211 5.79002L2.94829 0.546383H6.83612L8.11194 3.48364V0.546383H12.9449L13.7044 2.66934L14.4407 0.546383H36.1355V1.61367C36.1355 1.61367 37.276 0.546383 39.1503 0.546383L46.1894 0.570995L47.4432 3.46981V0.546383H51.4877L52.6008 2.21152V0.546383H56.6824V9.96633H52.6008L51.5341 8.2958V9.96633H45.5919L44.9943 8.48141H43.3969L42.809 9.96633H38.7792C37.1664 9.96633 36.1355 8.92084 36.1355 8.92084V9.96633H30.0595L28.8536 8.48141V9.96633H6.26016L5.663 8.48141H4.07064L3.4777 9.96633L0.700211 9.96636V5.79002Z"
                  fill="black"></path>
                <path
                  d="M3.74398 1.70766L0.711806 8.76102H2.68591L3.24538 7.34861H6.49787L7.05444 8.76102H9.07203L6.04275 1.70766H3.74398ZM4.86583 3.34919L5.85723 5.81729H3.87153L4.86583 3.34919Z"
                  fill="currentColor"></path>
                <path
                  d="M9.28074 8.75983V1.70647L12.0861 1.7169L13.7177 6.26446L15.3103 1.70647H18.0932V8.75983H16.3307V3.56262L14.4624 8.75983H12.9167L11.0432 3.56262V8.75983H9.28074Z"
                  fill="currentColor"></path>
                <path
                  d="M19.2991 8.75983V1.70647H25.0504V3.2842H21.0801V4.49069H24.9576V5.97561H21.0801V7.22851H25.0504V8.75983H19.2991Z"
                  fill="currentColor"></path>
                <path
                  d="M26.0708 1.70766V8.76102H27.8332V6.25522H28.5753L30.6886 8.76102H32.8424L30.5234 6.16242C31.4751 6.08207 32.4569 5.26479 32.4569 3.99595C32.4569 2.51167 31.2925 1.70766 29.9929 1.70766H26.0708ZM27.8332 3.28538H29.8479C30.3312 3.28538 30.6828 3.66361 30.6828 4.02784C30.6828 4.49644 30.2273 4.77031 29.874 4.77031H27.8332V3.28538Z"
                  fill="currentColor"></path>
                <path d="M34.976 8.75983H33.1764V1.70647H34.976V8.75983Z" fill="currentColor"></path>
                <path
                  d="M39.243 8.75983H38.8546C36.9751 8.75983 35.834 7.2784 35.834 5.26215C35.834 3.19609 36.9624 1.70647 39.3358 1.70647H41.2838V3.377H39.2646C38.3011 3.377 37.6197 4.12927 37.6197 5.27956C37.6197 6.64552 38.3988 7.21923 39.5213 7.21923H39.9851L39.243 8.75983Z"
                  fill="currentColor"></path>
                <path
                  d="M43.0782 1.70766L40.046 8.76102H42.0201L42.5796 7.34861H45.8321L46.3886 8.76102H48.4062L45.377 1.70766H43.0782ZM44.2 3.34919L45.1914 5.81729H43.2057L44.2 3.34919Z"
                  fill="currentColor"></path>
                <path
                  d="M48.612 8.75983V1.70647H50.8528L53.714 6.13803V1.70647H55.4765V8.75983H53.3082L50.3745 4.21227V8.75983H48.612Z"
                  fill="currentColor"></path>
                <path
                  d="M13.5478 21.1032V14.0499H19.2991V15.6276H15.3289V16.8341H19.2063V18.319H15.3289V19.5719H19.2991V21.1032H13.5478Z"
                  fill="currentColor"></path>
                <path
                  d="M41.7291 21.1032V14.0499H47.4803V15.6276H43.5101V16.8341H47.369V18.319H43.5101V19.5719H47.4803V21.1032H41.7291Z"
                  fill="currentColor"></path>
                <path
                  d="M19.5223 21.1032L22.3226 17.62L19.4556 14.0499H21.6761L23.3835 16.2569L25.0968 14.0499H27.2303L24.401 17.5765L27.2065 21.1032H24.9863L23.3285 18.9309L21.7109 21.1032H19.5223Z"
                  fill="currentColor"></path>
                <path
                  d="M27.4158 14.051V21.1044H29.2247V18.877H31.0799C32.6497 18.877 33.8396 18.0438 33.8396 16.4234C33.8396 15.0811 32.9064 14.051 31.3089 14.051H27.4158ZM29.2247 15.6462H31.1785C31.6856 15.6462 32.0481 15.9572 32.0481 16.4582C32.0481 16.929 31.6875 17.2703 31.1727 17.2703H29.2247V15.6462Z"
                  fill="currentColor"></path>
                <path
                  d="M34.6049 14.0499V21.1032H36.3674V18.5974H37.1095L39.2227 21.1032H41.3766L39.0575 18.5046C40.0093 18.4243 40.991 17.607 40.991 16.3381C40.991 14.8539 39.8266 14.0499 38.527 14.0499H34.6049ZM36.3674 15.6276H38.3821C38.8654 15.6276 39.2169 16.0058 39.2169 16.37C39.2169 16.8386 38.7614 17.1125 38.4082 17.1125H36.3674V15.6276Z"
                  fill="currentColor"></path>
                <path
                  d="M48.2967 21.1032V19.5719H51.824C52.3459 19.5719 52.5718 19.2897 52.5718 18.9803C52.5718 18.6837 52.3466 18.384 51.824 18.384H50.23C48.8445 18.384 48.0729 17.5394 48.0729 16.2714C48.0729 15.1405 48.7795 14.0499 50.8383 14.0499H54.2706L53.5285 15.6369H50.5601C49.9926 15.6369 49.818 15.9348 49.818 16.2192C49.818 16.5116 50.0338 16.8341 50.4673 16.8341H52.137C53.6815 16.8341 54.3517 17.7106 54.3517 18.8584C54.3517 20.0925 53.6049 21.1032 52.0529 21.1032H48.2967Z"
                  fill="currentColor"></path>
                <path
                  d="M54.7654 21.1032V19.5719H58.2927C58.8146 19.5719 59.0406 19.2897 59.0406 18.9803C59.0406 18.6837 58.8153 18.384 58.2927 18.384H56.6987C55.3132 18.384 54.5416 17.5394 54.5416 16.2714C54.5416 15.1405 55.2482 14.0499 57.3071 14.0499H60.7393L59.9972 15.6369H57.0288C56.4614 15.6369 56.2867 15.9348 56.2867 16.2192C56.2867 16.5116 56.5026 16.8341 56.936 16.8341H58.6058C60.1503 16.8341 60.8205 17.7106 60.8205 18.8584C60.8205 20.0925 60.0737 21.1032 58.5217 21.1032H54.7654Z"
                  fill="currentColor"></path>
              </svg><svg xmlns="http://www.w3.org/2000/svg" width="85" height="15" viewbox="0 0 85 15"
                fill="black">
                <path
                  d="M3.94587 0.809258H0.153793V14.0342H3.89367C5.89225 14.0342 7.3278 13.5699 8.61047 12.4915C10.0982 11.2559 11.0192 9.35379 11.0192 7.39551C11.0192 3.53512 8.09964 0.809258 3.94587 0.809258ZM6.92137 10.7429C6.10106 11.4618 5.07567 11.7726 3.38657 11.7726H2.71913V3.02215H3.38657C5.02719 3.02215 6.05259 3.32918 6.92137 4.10426C7.84236 4.92801 8.35692 6.16363 8.35692 7.39925C8.35319 8.68355 7.84236 9.96786 6.92137 10.7429Z">
                </path>
                <path d="M14.7591 0.809258H12.1975V14.0342H14.7591V0.809258Z"></path>
                <path
                  d="M21.0643 5.85285C19.5281 5.28746 19.0657 4.928 19.0657 4.20535C19.0657 3.3816 19.886 2.76379 20.9636 2.76379C21.7317 2.76379 22.347 3.07082 23.0666 3.8459L24.3978 2.04488C23.2717 1.06762 21.989 0.550899 20.5013 0.550899C18.1447 0.550899 16.3997 2.1984 16.3997 4.35887C16.3997 6.21231 17.22 7.13715 19.6288 8.01332C20.6541 8.37278 21.165 8.63113 21.4223 8.78465C21.9331 9.09169 22.1904 9.6084 22.1904 10.1738C22.1904 11.2559 21.3179 12.0272 20.1918 12.0272C18.9613 12.0272 17.9881 11.4094 17.3729 10.2786L15.7323 11.8213C16.9105 13.5699 18.3461 14.3412 20.2925 14.3412C22.9585 14.3412 24.8527 12.5402 24.8527 9.96785C24.8564 7.91222 23.9876 6.93496 21.0643 5.85285Z">
                </path>
                <path
                  d="M25.6767 7.44793C25.6767 11.3607 28.7007 14.345 32.6456 14.345C33.7717 14.345 34.6964 14.139 35.8747 13.5736V10.537C34.8493 11.5667 33.9283 11.9786 32.75 11.9786C30.1362 11.9786 28.3427 10.0727 28.3427 7.39926C28.3427 4.87933 30.2406 2.86863 32.6493 2.86863C33.8798 2.86863 34.8008 3.28051 35.8784 4.36261V1.32597C34.7523 0.760583 33.8276 0.502225 32.7015 0.502225C28.8051 0.49848 25.6767 3.58754 25.6767 7.44793Z">
                </path>
                <path
                  d="M56.6845 9.71324L53.1982 0.809258H50.3793L55.9649 14.3974H57.3519L63.0382 0.809258H60.2715L56.6845 9.71324Z">
                </path>
                <path
                  d="M64.2165 14.0342H71.4949V11.8213H66.7818V8.21926H71.342V5.95395H66.7818V3.02215H71.4949V0.809258H64.2165V14.0342Z">
                </path>
                <path
                  d="M81.6928 4.71832C81.6928 2.24707 80 0.805512 77.0283 0.805512H73.1877V14.0304H75.7493V8.73597H76.1073L79.6421 14.0379H82.8189L78.6689 8.47762C80.619 8.06574 81.6928 6.72902 81.6928 4.71832ZM76.5174 6.88254H75.7493V2.86863H76.5174C78.1058 2.86863 78.9784 3.53886 78.9784 4.82316C79.0306 6.15988 78.158 6.88254 76.5174 6.88254Z">
                </path>
                <path
                  d="M43.9728 14.4963C47.8216 14.4963 50.9417 11.3631 50.9417 7.49813C50.9417 3.63317 47.8216 0.5 43.9728 0.5C40.124 0.5 37.0039 3.63317 37.0039 7.49813C37.0039 11.3631 40.124 14.4963 43.9728 14.4963Z">
                </path>
                <path
                  d="M43.9728 14.5C47.8208 14.5 50.9417 11.366 50.9417 7.50187C50.9417 3.63774 47.8245 0.5 43.9728 0.5C40.1211 0.5 37.0039 3.63399 37.0039 7.49813C37.0039 11.3623 40.1248 14.5 43.9728 14.5Z">
                </path>
                <path
                  d="M83.4876 1.37617C83.4876 1.11781 83.3347 1.01672 83.0253 1.01672H82.6151V2.25234H82.9209V1.73562L83.2788 2.19992H83.6368L83.2266 1.68695C83.3869 1.6832 83.4876 1.52969 83.4876 1.37617ZM82.9768 1.52969L82.9246 1.22265H82.9768C83.1297 1.22265 83.1819 1.27507 83.1819 1.37617C83.1819 1.47727 83.0775 1.52969 82.9768 1.52969Z">
                </path>
                <path
                  d="M83.0775 0.5C82.4622 0.5 81.9999 0.964296 81.9999 1.58211C81.9999 2.19992 82.4622 2.66421 83.0775 2.66421C83.6405 2.66421 84.1551 2.19992 84.1551 1.58211C84.1029 1.01297 83.6405 0.5 83.0775 0.5ZM83.0775 2.45453C82.6151 2.45453 82.205 2.04266 82.205 1.57836C82.205 1.06539 82.5629 0.702194 83.0775 0.702194C83.5398 0.702194 83.8978 1.11407 83.8978 1.57836C83.8978 2.09508 83.5398 2.45453 83.0775 2.45453Z">
                </path>
              </svg><a target="_blank" href="https://www.trustpilot.com/review/fly.business"
                class="hover:text-gray-500"><svg xmlns="http://www.w3.org/2000/svg" width="73" height="19"
                  viewbox="0 0 73 19" style="color:black">
                  <g clip-path="url(#clip0_3169_761)">
                    <path
                      d="M26.9919 6.88V8.26462H24.1254V16.0482H22.5491V8.26462H19.6953V6.88H26.9919ZM28.0279 9.40984V10.6909H28.0534C28.0979 10.5098 28.1805 10.3351 28.3012 10.1668C28.422 9.99862 28.5682 9.83687 28.7398 9.701C28.9114 9.55865 29.1021 9.44866 29.3118 9.35808C29.5216 9.27397 29.7377 9.22867 29.9538 9.22867C30.119 9.22867 30.2398 9.23515 30.3034 9.24162C30.3669 9.24809 30.4305 9.26103 30.5004 9.2675V10.678C30.3987 10.6586 30.297 10.6456 30.189 10.6327C30.0809 10.6198 29.9792 10.6133 29.8775 10.6133C29.636 10.6133 29.4072 10.6651 29.1911 10.7621C28.975 10.8592 28.7907 11.008 28.6318 11.1956C28.4729 11.3897 28.3457 11.6226 28.2504 11.9073C28.1551 12.192 28.1106 12.5155 28.1106 12.8843V16.0418H26.6741V9.40984H28.0279ZM37.1042 16.0482H35.6932V15.123H35.6678C35.4898 15.4594 35.2292 15.7247 34.8796 15.9253C34.5301 16.1259 34.1741 16.2294 33.8118 16.2294C32.9538 16.2294 32.3309 16.0159 31.9495 15.5824C31.5682 15.1489 31.3775 14.4954 31.3775 13.6219V9.40984H32.814V13.4796C32.814 14.0619 32.922 14.476 33.1445 14.7154C33.3606 14.9548 33.672 15.0777 34.0661 15.0777C34.3712 15
path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M48.9147 13.049L52.8467 13.0834C54.7987 13.0309 56.2915 16.5118 53.7702 18.3819C57.133 19.3218 55.9191 23.8772 53.224 23.8854L48.8819 23.9543L48.2667 21.971L52.4038 22.0055C53.7144 22.0432 53.7981 19.3973 52.4382 19.3726L48.644 19.4415L48.5407 17.3911H51.9248C53.4667 17.455 52.9877 14.9961 51.9592 14.9977L48.5751 14.9288L48.2339 13.3902L48.9179 13.049H48.9147Z"
                  fill="currentColor"></path>
              </svg><a target="_blank" href="https://www.ccra.com/check-true-code/"
                class="flex gap-2 hover:text-gray-500"><svg xmlns="http://www.w3.org/2000/svg" width="3.12em"
                  height="1em" viewbox="0 0 78 25" style="color:black">
                  <path
                    d="M74.5207 8.19877C74.5207 7.75442 74.677 7.37997 74.9844 7.07541C75.3018 6.77585 75.6899 6.62107 76.1535 6.61608C76.6171 6.61109 77.0051 6.76087 77.3125 7.06043C77.625 7.36 77.7812 7.73445 77.7812 8.19378C77.7812 8.65311 77.625 9.02756 77.3125 9.32713C77.0001 9.62669 76.6121 9.78146 76.1535 9.78146C75.6949 9.78146 75.3018 9.63168 74.9844 9.32713C74.6719 9.03256 74.5207 8.65311 74.5207 8.19877ZM75.2212 9.10245C75.4681 9.33711 75.7755 9.45694 76.1535 9.45694C76.5264 9.45694 76.8388 9.33711 77.0757 9.10245C77.3226 8.85781 77.4436 8.55825 77.4436 8.19877C77.4436 7.8343 77.3226 7.53474 77.0757 7.30008C76.8338 7.06543 76.5264 6.9456 76.1535 6.9456C75.7806 6.9456 75.4681 7.06543 75.2212 7.30008C74.9793 7.53474 74.8584 7.8343 74.8584 8.19877C74.8584 8.56324 74.9793 8.8678 75.2212 9.10245ZM76.9547 7.89921C76.9547 8.16382 76.8338 8.34356 76.5869 8.4534L76.985 9.11743H76.4155L76.1132 8.53828H75.9318V9.11743H75.4278V7.24516H76.1787C76.4206 7.24516 76.607 7.30508 76.7481 7.41991C76.8842 7.53474 76.9547 7.6995 76.9547 7.89921ZM76.1736 7.68952H75.9318V8.1139H76.1736C76.3551 8.1139 76.4458 8.044 76.4458 7.9042C76.4458 7.76441 76.3551 7.68952 76.1736 7.68952Z"
                    fill="currentColor"></path>
                  <path d="M40.4298 6.61109V8.95767H36.9577V18.0494H34.5035V8.95767H31.0314V6.61109H40.4298Z"
                ...
                <div class="flex flex-col text-xs"><span style="color:black">TRUE Code:</span><span style="color:black">99931160</span></div>
              </a></div>
          </div>
        </div>
        <div class="flex max-sm:flex-col items-center justify-center gap-2.5 p-5 bg-brand text-white">
          ...
          <div class="flex items-center gap-3 pl-2.5 sm:border-l border-white max-sm:text-sm"><a
              href="privacy-policy.html" rel="noopener noreferrer" target="_blank"
              class="group relative isolate w-fit pointer-events-none"> Privacy Policy <span aria-hidden="true"
                class="absolute top-full left-0 w-full h-px bg-current scale-x-100 group-hover:scale-x-0 transition origin-left"></span></a><a
              href="terms.html" rel="noopener noreferrer" target="_blank"
              class="group relative isolate w-fit pointer-events-none"> Terms &amp; Conditions <span aria-hidden="true"
                class="absolute top-full left-0 w-full h-px bg-current scale-x-100 group-hover:scale-x-0 transition origin-left"></span></a>
          </div>
        </div>
      </footer>
    </div>
