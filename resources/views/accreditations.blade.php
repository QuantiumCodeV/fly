...
<head>
  ...
  <title>Privacy Policy | Luxury Airways</title>
  <style>
    ...
    *,
    ...
    .bg-\[\#f0ece3\] {
      ...
      background-color: rgb(239 234 223/var(--tw-bg-opacity))
    }
    ...
    .bg-\[linear-gradient\(180deg\,\#9CC3FE\,\#f0ece3\)\] {
      background-image: linear-gradient(180deg, #9cc3fe, #f0ece3)
    }
    ...
    .bg-\[linear-gradient\(180deg\,\#f0ece3\,\#FFF\)\] {
      background-image: linear-gradient(180deg, #f0ece3, #fff)
    }

    .bg-\[linear-gradient\(180deg\,\#FFF\,\#f0ece3\)\] {
      background-image: linear-gradient(180deg, #fff, #f0ece3)
    }
    ...
    .odd\:bg-\[\#f0ece3\]:nth-child(odd) {
      --tw-bg-opacity: 1;
      background-color: #f0ece3;
      background-color: rgb(239 234 223/var(--tw-bg-opacity))
    }

    .odd\:bg-\[--best-deals-section-odd-bg-color\,\#f0ece3\]:nth-child(odd) {
      background-color: #f0ece3;
      background-color: var(--best-deals-section-odd-bg-color, #f0ece3)
    }
  ...
  <style>
    ...
    .dp__menu.dp__theme_light {
      --dp-background-color: #fff;
      --dp-text-color: #212121;
      --dp-hover-color: #d2c8b5;
      --dp-hover-text-color: #f8f5f5;
      --dp-hover-icon-color: #959595;
      --dp-primary-color: #d2c8b5;
      --dp-primary-text-color: #f8f5f5;
      --dp-secondary-color: #c0c4cc;
      --dp-border-color: #ddd;
      --dp-menu-border-color: #ddd;
    ...
    *,
    ...
    :root {
      --color-brand-50: color-mix(in srgb-linear, #fff 80%, #d2c8b5);
      --color-brand-100: color-mix(in srgb-linear, #fff 60%, #d2c8b5);
      --color-brand-200: color-mix(in srgb-linear, #fff 45%, #d2c8b5);
      --color-brand-300: color-mix(in srgb-linear, #fff 30%, #d2c8b5);
      --color-brand-400: color-mix(in srgb-linear, #fff 15%, #d2c8b5);
      --color-brand-500: #d2c8b5;
      --color-brand-600: color-mix(in srgb-linear, #000 15%, #d2c8b5);
      --color-brand-700: color-mix(in srgb-linear, #000 30%, #d2c8b5);
      --color-brand-800: color-mix(in srgb-linear, #000 45%, #d2c8b5);
      --color-brand-900: color-mix(in srgb-linear, #000 60%, #d2c8b5);
      --color-brand-950: color-mix(in srgb-linear, #000 80%, #d2c8b5);
    ...
    body {
      background-color: color-mix(in srgb-linear, #000 80%, #d2c8b5);
      background-color: var(--color-brand-950)
    }
    ...
    *,
    ...
    .border-brand-100 {
      border-color: color-mix(in srgb-linear, #fff 60%, #d2c8b5);
      border-color: var(--color-brand-100)
    }

    .border-brand-300 {
      border-color: color-mix(in srgb-linear, #fff 30%, #d2c8b5);
      border-color: var(--color-brand-300)
    }
    ...
    .bg-brand-50 {
      background-color: color-mix(in srgb-linear, #fff 80%, #d2c8b5);
      background-color: var(--color-brand-50)
    }
    ...
    .bg-brand-700 {
      background-color: color-mix(in srgb-linear, #000 30%, #d2c8b5);
      background-color: var(--color-brand-700)
    }
    ...
    .text-brand-800 {
      color: color-mix(in srgb-linear, #000 45%, #d2c8b5);
      color: var(--color-brand-800)
    }
    ...
    .hover\:text-brand-950:hover {
      color: color-mix(in srgb-linear, #000 80%, #d2c8b5);
      color: var(--color-brand-950)
    }
    ...
    .group\/slide:hover .group-hover\/slide\:bg-\[--best-deals-btn-hover-bg-color\,var\(--color-brand-600\)\] {
      background-color: color-mix(in srgb-linear, #000 15%, #d2c8b5);
      background-color: var(--best-deals-btn-hover-bg-color, var(--color-brand-600))
    }
  ...
  <style>
    .content[data-v-0d11afb1] h1,
    .content[data-v-0d11afb1] h2,
    .content[data-v-0d11afb1] h3,
    .content h1[data-v-0d11afb1-s],
    .content h2[data-v-0d11afb1-s],
    .content h3[data-v-0d11afb1-s] {
      margin-bottom: .8125rem
    }

    .content[data-v-0d11afb1] h1:not(:first-child),
    .content[data-v-0d11afb1] h2:not(:first-child),
    .content[data-v-0d11afb1] h3:not(:first-child),
    .content h1[data-v-0d11afb1-s]:not(:first-child),
    .content h2[data-v-0d11afb1-s]:not(:first-child),
    .content h3[data-v-0d11afb1-s]:not(:first-child) {
      margin-top: 2.5rem
    }

    .content[data-v-0d11afb1] h4,
    .content h4[data-v-0d11afb1-s] {
      margin-bottom: .625rem
    }

    .content[data-v-0d11afb1] h4:not(:first-child),
    .content h4[data-v-0d11afb1-s]:not(:first-child) {
      margin-top: .875rem
    }
    ...
    .content[data-v-0d11afb1] p,
    .content p[data-v-0d11afb1-s] {
      font-size: 1rem;
      font-style: normal;
      font-weight: 400;
      line-height: 150%;
    ...
    .content[data-v-0d11afb1] ul,
    .content ul[data-v-0d11afb1-s] {
      list-style: disc;
      padding-left: 1.25rem
    }

    .content[data-v-0d11afb1] ol,
    .content ol[data-v-0d11afb1-s] {
      list-style: decimal;
      padding-left: 1.25rem
    }

    .content[data-v-0d11afb1] li,
    .content li[data-v-0d11afb1-s] {
      font-size: 1rem;
      font-style: normal;
      font-weight: 400;
      letter-spacing: .005rem;
    ...
    .content[data-v-0d11afb1] a,
    .content a[data-v-0d11afb1-s] {
      font-size: 1rem;
      font-style: normal;
      font-weight: 400;
      letter-spacing: .005rem;
    ...
    .content[data-v-0d11afb1] a:hover,
    .content a[data-v-0d11afb1-s]:hover {
      color: #1677ff
    }
  </style>
  <style>
  ...
  <link rel="modulepreload" as="script" crossorigin href="_nuxt/Bkb6CBcx.js">
  <link rel="modulepreload" as="script" crossorigin href="_nuxt/Dp5joTXE.js">
  <link rel="modulepreload" as="script" crossorigin href="_nuxt/fpgtWgsE.js">
  ...
  <link rel="prefetch" as="script" crossorigin href="_nuxt/ZnXI8uO6.js">
  <link rel="prefetch" as="script" crossorigin href="_nuxt/A-2u7pNL.js">
  <link rel="prefetch" as="script" crossorigin href="_nuxt/28RPozEF.js">
  ...
  <link rel="prefetch" as="script" crossorigin href="_nuxt/1FZX-vAj.js">
  <link rel="prefetch" as="script" crossorigin href="_nuxt/BC_jq7W7.js">
  <link rel="prefetch" as="script" crossorigin href="_nuxt/CDl_TvWF.js">
  <link rel="prefetch" as="script" crossorigin href="_nuxt/BswbeSF2.js">
  <link rel="prefetch" as="script" crossorigin href="_nuxt/H91qDMJ2.js">
  <meta name="description" content="Specializing in Discounted Business Class Tickets, we ensure your comfort with smart financial choices. For Cheap Business Class Flights, we've got you covered.">
  <meta name="format-detection" content="telephone=no">
  <meta name="application-name" content="Luxury Airways">
  ...
  <link rel="icon" type="image/png" href="https://fly.business//logo.png" sizes="128x128">
  <meta property="og:url" content="https://fly.business/privacy-policy">
  ...
  <meta property="og:title" content="Privacy Policy | Luxury Airways">
  <meta name="twitter:title" content="Privacy Policy | Luxury Airways">
...
<body>
  <div id="__nuxt"><!--[-->
    ...
    <div>
      <header class="w-full pl-[calc(100vw-100%)] transition-colors duration-500 absolute h-20 md:h-32 z-50 text-black">
        <div class="container flex items-center justify-between h-full"><a href="/" class=""><svg xmlns="http://www.w3.org/2000/svg" width="10rem" height="40" viewbox="0 0 172 40">
      ...
      <main class="[--header-height:5rem] md:[--header-height:8rem]"><!--[-->
        <section class="pb-10 lg:pb-16 pt-10 lg:pt-16 bg-white odd:bg-[#f0ece3] group !pt-[--header-height]" data-v-0d11afb1><!---->
          <div class="content container bg-white shadow rounded-xl p-6" data-v-0d11afb1=""><!--[--><h1 data-v-0d11afb1-s="">Our Accreditations:</h1><p data-v-0d11afb1-s=""> Is Fly Business legit? At Fly Business, we prioritize trust and transparency in the travel industry, offering a range of premium services such as business class and first class flights at the lowest fares available. We are committed to providing a luxurious and comfortable business class experience, ensuring our customers receive high-quality service and dedicated customer support when booking affordable business class flights. Our focus on legitimacy and credibility makes us the preferred choice for those seeking elevated travel experiences. </p><p data-v-0d11afb1-s=""><strong data-v-0d11afb1-s="">TRUE Code: 99931160.</strong> Fly Business holds a TRUE (Travel Retailer Universal Enumeration) Code with the accreditation number 99931160. This accreditation, issued by the International Air Transport Association (IATA), signifies our dedication to upholding industry standards and best practices, guaranteeing excellence in travel services, including exclusive business class ticket deals. You can verify our CCRA Accredited Travel Agency's TRUE Code on the official website: <a href="https://www.ccra.com/check-true-code/" target="_blank" data-v-0d11afb1-s="">Verify TRUE Code</a></p><p data-v-0d11afb1-s=""><strong data-v-0d11afb1-s="">PCI Compliance.</strong> We are dedicated to ensuring the highest level of security for our customers. Fly Business is PCI (Payment Card Industry) compliant, adhering to stringent security standards to protect your payment information during transactions. This compliance underscores our commitment to your data security and privacy. </p><p data-v-0d11afb1-s=""><strong data-v-0d11afb1-s="">BBB A+ Rating.</strong> Fly Business is proud to hold an A+ rating from the Better Business Bureau (BBB), reflecting our dedication to resolving customer concerns promptly and maintaining the highest level of customer satisfaction. The BBB rating is a testament to our commitment to integrity, performance, and trustworthiness in all our business dealings. You can verify our BBB rating by visiting the official BBB website: Verify BBB Rating. </p><p data-v-0d11afb1-s=""> Our TRUE, BBB, and PCI compliance accreditations require strict adherence to industry regulations, financial stability, and an unwavering commitment to customer satisfaction. These accreditations assure our customers that they are dealing with a legitimate and highly reputable travel agency with the highest standards of data security. Our dedication to excellence is further reflected in our exclusive offerings, including discount business class tickets, enticing business class deals, and budget-friendly cheap business flights. Rest assured, our industry-recognized accreditations validate our commitment to the highest standards of data security, ensuring your peace of mind and privacy throughout your journey. </p><p data-v-0d11afb1-s=""> We also invite you to read the reviews from over 100 customers on <a href="https://www.trustpilot.com/review/fly.business" target="_blank" data-v-0d11afb1-s="">Trustpilot</a>. Their experiences reflect our commitment to excellence and our dedication to being a trusted and reputable choice for your travel needs. </p><img src="/_nuxt/securitymetrics.B42UxJNQ.png" alt="security metrics image" width="1942" height="1478" loading="lazy" class="mx-auto mt-6" data-v-0d11afb1-s=""><!--]--></div>
        </section><!--]-->
      </main>
      <footer class="flex flex-col gap-6 pt-10 bg-[#f0ece3]">
        <div class="container flex gap-6 max-xl:flex-col">
          <div class="flex gap-6 flex-col shrink-0">
            <div class="flex items-center justify-between gap-1 p-3 bg-white"><a href="/" class=""><svg xmlns="http://www.w3.org/2000/svg" width="10rem" height="40" viewbox="0 0 172 40" class="max-sm:hidden">
                  <path d="M56.2738 13.1767C56.2117 13.7687 56.1682 14.3421 56.1449 14.8939C56.1216 15.4473 56.1092 15.8723 56.1092 16.1675C56.1092 16.5416 56.117 16.8925 56.1325 17.2186C56.148 17.5463 56.1636 17.8338 56.1791 18.0826H55.6386C55.5283 16.9929 55.3808 16.1305 55.1929 15.4998C55.0049 14.8692 54.6757 14.4132 54.2066 14.1319C53.7376 13.8522 53.0092 13.7115 52.023 13.7115H50.5428C50.0101 13.7115 49.6063 13.7548 49.333 13.8398C49.0596 13.9248 48.8748 14.1056 48.7816 14.3777C48.6869 14.6497 48.6403 15.0748 48.6403 15.6513V27.2453C48.6403 27.8063 48.6993 28.2267 48.8158 28.5065C48.9338 28.7863 49.1637 28.9733 49.5085 29.0676C49.8533 29.1619 50.3534 29.2237 51.0119 29.2546V29.7214C50.605 29.6905 50.0878 29.6704 49.4619 29.6627C48.836 29.6549 48.2008 29.6518 47.5593 29.6518C46.949 29.6518 46.3774 29.6549 45.8447 29.6627C45.312 29.6704 44.8818 29.6905 44.5525 29.7214V29.2546C45.0852 29.2237 45.4875 29.1619 45.7624 29.0676C46.0357 28.9748 46.2205 28.7878 46.3137 28.5065C46.4085 28.2267 46.4551 27.8063 46.4551 27.2453V15.6513C46.4551 15.0748 46.4085 14.6497 46.3137 14.3777C46.219 14.1056 46.0357 13.9186 45.7624 13.8166C45.489 13.7146 45.0852 13.6574 44.5525 13.6404V13.1736C45.1318 13.1891 45.7422 13.2014 46.3836 13.2092C47.0251 13.2169 47.6603 13.2246 48.2862 13.2323C48.9121 13.2401 49.496 13.2447 50.0365 13.2447C50.577 13.2447 51.0196 13.2447 51.3629 13.2447C52.0835 13.2447 52.902 13.2416 53.8168 13.2323C54.7347 13.2262 55.5532 13.2076 56.2738 13.1767ZM52.6333 21.4027V21.8695H47.9367V21.4027H52.6333ZM53.0791 18.3176C53.0169 19.2063 52.989 19.8833 52.9968 20.3516C53.0045 20.8184 53.0092 21.2481 53.0092 21.6376C53.0092 22.0271 53.0169 22.4553 53.0325 22.9236C53.048 23.3904 53.0868 24.0689 53.1505 24.9577H52.61C52.5479 24.4584 52.4734 23.9716 52.3864 23
              <div class="relative isolate mb-1.5 mr-1.5 group"><span aria-hidden="true" class="absolute top-1.5 left-1.5 w-full h-full rounded border-2 border-brand-100 -z-10 group-hover:top-0 group-hover:left-0 transition-all pointer-events-none"></span><a href="tel:+18776571177" class="flex flex-col items-center px-3 py-1 text-sm tracking-wider bg-brand hover:bg-brand-700 transition-colors text-white rounded"><span class="font-bold">FREE PHONE-ONLY DEALS</span><span>+1 (315) 260-2111</span></a></div>
            </div>
            <div class="flex max-sm:flex-col max-sm:items-center justify-between gap-2">
              <div class="flex flex-col">
                <div>Follow us on Social Media:</div>
                <div class="flex max-sm:justify-center gap-2 text-2xl"><a target="_blank" href="https://www.instagram.com/flybusiness360" aria-label="Luxury Airways Instagram page" class="hover:text-brand"><span class="iconify i-simple-icons:instagram" aria-hidden="true" style=""></span></a><a target="_blank" href="https://www.facebook.com/flybusiness360" aria-label="Luxury Airways Facebook page" class="hover:text-brand"><span class="iconify i-simple-icons:facebook" aria-hidden="true" style=""></span></a></div>
              </div>
              <div class="flex flex-col max-sm:items-center">
                <div>Customer Service</div>
                <div class="flex max-sm:gap-3 sm:gap-2 text-brand"><a href="tel:+18775133776" class="group relative isolate w-fit pointer-events-none">+1 (315) 260-2111 <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="cdn-cgi/l/email-protection.html#8be8f8cbede7f2a5e9fef8e2e5eef8f8" class="group relative isolate w-fit pointer-events-none"><span class="__cf_email__" data-cfemail="c1a2b281a7adb8efa3b4b2a8afa4b2b2">[email&#160;protected]</span> <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a></div>
              </div>
            </div><!--[-->
            <nav class="max-md:hidden grid grid-cols-4 gap-5"><!--[-->
              <div class="flex flex-col gap-2.5">
                <div class="text-lg uppercase font-semibold">Top Regions</div>
                <div class="flex flex-col gap-2"><!--[--><a href="business-class/europe.html" class="group relative isolate w-fit pointer-events-none">Europe <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/asia.html" class="group relative isolate w-fit pointer-events-none">Asia <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/africa.html" class="group relative isolate w-fit pointer-events-none">Africa <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/oceania.html" class="group relative isolate w-fit pointer-events-none">Oceania <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/middle-east.html" class="group relative isolate w-fit pointer-events-none">Middle East <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/latin-america.html" class="group relative isolate w-fit pointer-events-none">Latin America <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/indian-subcontinent.html" class="group relative isolate w-fit pointer-events-none">Indian Subcontinent <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]--></div>
              </div>
              <div class="flex flex-col gap-2.5">
                <div class="text-lg uppercase font-semibold">Top Countries</div>
                <div class="flex flex-col gap-2"><!--[--><a href="business-class/europe/united-kingdom.html" class="group relative isolate w-fit pointer-events-none">United Kingdom <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/asia/japan.html" class="group relative isolate w-fit pointer-events-none">Japan <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/africa/tanzania.html" class="group relative isolate w-fit pointer-events-none">Tanzania <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/oceania/new-zealand.html" class="group relative isolate w-fit pointer-events-none">New Zealand <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/middle-east/qatar.html" class="group relative isolate w-fit pointer-events-none">Qatar <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/latin-america/brazil.html" class="group relative isolate w-fit pointer-events-none">Brazil <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/indian-subcontinent/maldives.html" class="group relative isolate w-fit pointer-events-none">Maldives <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]--></div>
              </div>
              <div class="flex flex-col gap-2.5">
                <div class="text-lg uppercase font-semibold">Top Cities</div>
                <div class="flex flex-col gap-2"><!--[--><a href="business-class/europe/france/paris.html" class="group relative isolate w-fit pointer-events-none">Paris <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/asia/china/beijing.html" class="group relative isolate w-fit pointer-events-none">Beijing <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/africa/south-africa/cape-town.html" class="group relative isolate w-fit pointer-events-none">Cape Town <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/oceania/australia/sydney.html" class="group relative isolate w-fit pointer-events-none">Sydney <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/middle-east/united-arab-emirates/dubai.html" class="group relative isolate w-fit pointer-events-none">Dubai <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/latin-america/argentina/buenos-aires.html" class="group relative isolate w-fit pointer-events-none">Buenos Aires <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="business-class/asia/south-korea/seoul.html" class="group relative isolate w-fit pointer-events-none">Seoul <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]--></div>
              </div>
              <div class="flex flex-col gap-2.5">
                <div class="text-lg uppercase font-semibold">Top Airlines</div>
                <div class="flex flex-col gap-2"><!--[--><a href="airlines/american-airlines.html" class="group relative isolate w-fit pointer-events-none">American Airlines <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="airlines/turkish-airlines.html" class="group relative isolate w-fit pointer-events-none">Turkish Airlines <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="airlines/united-airlines.html" class="group relative isolate w-fit pointer-events-none">United Airlines <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="airlines/delta-airlines.html" class="group relative isolate w-fit pointer-events-none">Delta Air Lines <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="airlines/qatar-airways.html" class="group relative isolate w-fit pointer-events-none">Qatar Airways <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="airlines/lufthansa.html" class="group relative isolate w-fit pointer-events-none">Lufthansa <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a href="airlines/emirates.html" class="group relative isolate w-fit pointer-events-none">Emirates <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]--></div>
              </div><!--]-->
            </nav>
            <nav class="md:hidden flex flex-col gap-3.5"><!--[--><!--[-->
              <div data-state="closed" data-orientation="vertical"><!--[--><!--[--><button type="button" aria-controls aria-expanded="false" data-state="closed" id="radix-vue-accordion-trigger-v-0-2-0" data-radix-vue-collection-item data-orientation="vertical" class="group w-full flex items-center justify-center gap-1.5 uppercase font-semibold"><!--[--><!--[-->Top Regions <span class="iconify i-mingcute:down-line text-xl group-data-[state=&#39;open&#39;]:rotate-180 transition" aria-hidden="true" style=""></span><!--]--><!--]--></button>
                <div role="region" hidden aria-labelledby="radix-vue-accordion-trigger-v-0-2-0" data-state="closed" data-orientation="vertical" style="--radix-accordion-content-width:var(--radix-collapsible-content-width);--radix-accordion-content-height:var(--radix-collapsible-content-height);--radix-collapsible-content-height:0px;--radix-collapsible-content-width:0px;" class="accordion-content flex flex-col items-center gap-2 pt-2.5" id="radix-vue-collapsible-content-v-0-2-1"><!----></div><!--]--><!--]-->
              </div>
              <div data-state="closed" data-orientation="vertical"><!--[--><!--[--><button type="button" aria-controls aria-expanded="false" data-state="closed" id="radix-vue-accordion-trigger-v-0-2-2" data-radix-vue-collection-item data-orientation="vertical" class="group w-full flex items-center justify-center gap-1.5 uppercase font-semibold"><!--[--><!--[-->Top Countries <span class="iconify i-mingcute:down-line text-xl group-data-[state=&#39;open&#39;]:rotate-180 transition" aria-hidden="true" style=""></span><!--]--><!--]--></button>
                <div role="region" hidden aria-labelledby="radix-vue-accordion-trigger-v-0-2-2" data-state="closed" data-orientation="vertical" style="--radix-accordion-content-width:var(--radix-collapsible-content-width);--radix-accordion-content-height:var(--radix-collapsible-content-height);--radix-collapsible-content-height:0px;--radix-collapsible-content-width:0px;" class="accordion-content flex flex-col items-center gap-2 pt-2.5" id="radix-vue-collapsible-content-v-0-2-3"><!----></div><!--]--><!--]-->
              </div>
              <div data-state="closed" data-orientation="vertical"><!--[--><!--[--><button type="button" aria-controls aria-expanded="false" data-state="closed" id="radix-vue-accordion-trigger-v-0-2-4" data-radix-vue-collection-item data-orientation="vertical" class="group w-full flex items-center justify-center gap-1.5 uppercase font-semibold"><!--[--><!--[-->Top Cities <span class="iconify i-mingcute:down-line text-xl group-data-[state=&#39;open&#39;]:rotate-180 transition" aria-hidden="true" style=""></span><!--]--><!--]--></button>
                <div role="region" hidden aria-labelledby="radix-vue-accordion-trigger-v-0-2-4" data-state="closed" data-orientation="vertical" style="--radix-accordion-content-width:var(--radix-collapsible-content-width);--radix-accordion-content-height:var(--radix-collapsible-content-height);--radix-collapsible-content-height:0px;--radix-collapsible-content-width:0px;" class="accordion-content flex flex-col items-center gap-2 pt-2.5" id="radix-vue-collapsible-content-v-0-2-5"><!----></div><!--]--><!--]-->
              </div>
              <div data-state="closed" data-orientation="vertical"><!--[--><!--[--><button type="button" aria-controls aria-expanded="false" data-state="closed" id="radix-vue-accordion-trigger-v-0-2-6" data-radix-vue-collection-item data-orientation="vertical" class="group w-full flex items-center justify-center gap-1.5 uppercase font-semibold"><!--[--><!--[-->Top Airlines <span class="iconify i-mingcute:down-line text-xl group-data-[state=&#39;open&#39;]:rotate-180 transition" aria-hidden="true" style=""></span><!--]--><!--]--></button>
                <div role="region" hidden aria-labelledby="radix-vue-accordion-trigger-v-0-2-6" data-state="closed" data-orientation="vertical" style="--radix-accordion-content-width:var(--radix-collapsible-content-width);--radix-accordion-content-height:var(--radix-collapsible-content-height);--radix-collapsible-content-height:0px;--radix-collapsible-content-width:0px;" class="accordion-content flex flex-col items-center gap-2 pt-2.5" id="radix-vue-collapsible-content-v-0-2-7"><!----></div><!--]--><!--]-->
              </div><!--]--><!--]-->
            </nav><!--]-->
          </div>
        ...
        <div class="flex max-sm:flex-col items-center justify-center gap-2.5 p-5 bg-brand text-white">
          <div class="text-sm">© Luxury Airways, 2025. All rights reserved.</div>
          <div class="flex items-center gap-3 pl-2.5 sm:border-l border-white max-sm:text-sm"><a href="privacy-policy.html" rel="noopener noreferrer" target="_blank" class="group relative isolate w-fit pointer-events-none"> Privacy Policy <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-100 group-hover:scale-x-0 transition origin-left"></span></a><a href="terms.html" rel="noopener noreferrer" target="_blank" class="group relative isolate w-fit pointer-events-none"> Terms &amp; Conditions <span aria-hidden="true" class="absolute top-full left-0 w-full h-px bg-current scale-x-100 group-hover:scale-x-0 transition origin-left"></span></a></div>
        </div>
      </footer>
    </div>
    <div></div><!----><!--]-->
...
<script type="text/javascript">
  ...
  _smartsupp.key = 'e204e96e4c099e58ae6630e4c12823edb7212c8f';
