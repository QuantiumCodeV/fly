<!DOCTYPE html>
<!-- saved from url=(0042)/thank-you?name=412343 -->
<html lang="en">
<div
    id="in-page-channel-node-id"
    data-channel-name="in_page_channel_gpWyOc"></div>
...
<head>
    ...
    <style>
        :where(.i-ic\:round-subdirectory-arrow-right) {
    ...
    <style>
        ...
        *,
        ...
        .max-h-\[min\(var\(--radix-dropdown-menu-content-available-height\)\,10rem\)\] {
            max-height: min(var(--radix-dropdown-menu-content-available-height),
                    10rem);
        }
        ...
        .rotate-180 {
            --tw-rotate: 180deg;
            transform: translate(var(--tw-translate-x),
                    var(--tw-translate-y)) rotate(180deg) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
            transform: translate(var(--tw-translate-x),
                    var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
        }
        ...
        .-scale-100 {
            ...
            --tw-scale-y: -1;
            transform: translate(var(--tw-translate-x),
                    var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(-1) scaleY(-1);
            transform: translate(var(--tw-translate-x),
                    var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
        }
        ...
        .-scale-x-100 {
            --tw-scale-x: -1;
            transform: translate(var(--tw-translate-x),
                    var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(-1) scaleY(var(--tw-scale-y));
            transform: translate(var(--tw-translate-x),
                    var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
        }
        ...
        .scale-x-0 {
            --tw-scale-x: 0;
            transform: translate(var(--tw-translate-x),
                    var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(0) scaleY(var(--tw-scale-y));
            transform: translate(var(--tw-translate-x),
                    var(--tw-translate-y)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
        }
        ...
        .border-\[--best-deals-border-color\,var\(--color-brand-500\)\] {
            border-color: var(--best-deals-border-color,
                    var(--color-brand-500));
        }
        ...
        .bg-\[--best-deals-accent-color\,var\(--color-brand-500\)\] {
            background-color: var(--best-deals-accent-color,
                    var(--color-brand-500));
        }

        .bg-\[--best-deals-btn-bg-color\,var\(--color-brand-500\)\] {
            background-color: var(--best-deals-btn-bg-color,
                    var(--color-brand-500));
        }
        ...
        .odd\:bg-\[--best-deals-section-odd-bg-color\,\#F6FBFF\]:nth-child(odd) {
            background-color: #f6fbff;
            background-color: var(--best-deals-section-odd-bg-color,
                    #f6fbff);
        }
        ...
        .group\/slide:hover .group-hover\/slide\:bg-\[--best-deals-btn-hover-bg-color\,var\(--color-brand-600\)\] {
            background-color: var(--best-deals-btn-hover-bg-color,
                    var(--color-brand-600));
        }
    ...
    <style>
        ...
        :root {
            ...
            --dp-font-family: -apple-system, blinkmacsystemfont, "Segoe UI",
        ...
        *,
        ...
        @media (min-width: 768px) {
            ...
            .md\:text-gray-200 {
                --tw-text-opacity: 1;
                color: #e5e7eb;
                b(229 231 235 / var(--tw-text-opacity));
            }
            ...
            @media not al24px) {
                .md\:max-lg\:grid-cols-2 {
                    ...
                    .> :not([hidden])~ :not([hidden]) {
                        --tw-divide-x-reverse: 0;
                        border-left-width: 1px;
                        left-width: calc(1px * (1 - var(--tw-divide-x-reverse)));
                        border-rig border-right-width: calc(1px * var(--tw-divide-x-reverse));

                        .md\:max-lg\:divide-y-0> :not([hidden])~ :not([hidden]) {
                            --tw-divide-y-reverse: 0;
                            borde border-bottom-width: calc(0px * var(--tw-divide-y-reverse));
                            er-top-width: 0;
                            border-top-width: calc(0px * (1 - var(--tw-divide-y-reverse))
                            }
                        }
                    ...
                    @media (min-width: 1024px) {
                        ...
                        .lg\:grid-cols-3 {
                            ...
                            .lg\:grid-cols-\[1fr_a grid-template-columns: 1fr auto;
                        }
                        ...
                        e-x> :not([hidden])~ :not([hidden]) {
                            --tw-divide-x-reverse: 0;
                            border-left-width: 1px;
                            h: calc(1px * (1 - var(--tw-divide-x-reverse)));
                            border-right-width: 0;
                            ight-width: calc(1px * var(--tw-divide-x-reverse));
                        }
                        ...
                        .lg\:overflow-y-auto {
                            ...
                            .lg\:bg-\[image\:--bg-lg\] {
                                background-image: var(--bg-lg .lg\:p-6 {
                                        padding: 1.5rem;
                                    }

                                    .lg\:py-1_nuxt padding-bottom: 4rem;
                                    padding-top: 4rem;
                                }
                                ...
                                .lg\:text-3xl _nuxt font-size: 1.875rem;
                                line-h_nuxt
                            }
                        ...
                        @media (min-width: 1280px) {
                            ...
                            .xl\:col-span-2 {
                                ...
                                .xl\_nuxt {
                                    --tw-translate-y: 0px;
                                    t_nuxtlate(var(--tw-translate-x)) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw- transform: translate(var(--tw-translate-x),
                                                var(--tw-translate-y) rotate(var(--tw-rotate)) skew(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale- scaleY(var(--tw-scale-y));
                                                    }
                                                    ...
                                                    .xl\:grid-cols-2 {
                                                        ...
                                                        .xl\:grid-cols-\[1fr_440p grid-template-columns: 1fr 440px;
                                                    }
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: 100;
            src: url(/_nuxt/Inter-100-1.DIEz8off2");
            unicode-range: u+0460-052f, u+1c80-1c88, u+20b4, u+2de0-2dff,
                u+a640-a69f, u+fe2e-fe2f;
        }

        @font-facfont-display: swap;
        font-family: Inter;
        font-style: normal;
        font-weight: 100;
        src: url(/_nuxt/Inter-100-2mat("woff2");
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 100;
            src: url(/_nuxt/Inter-100-3.D5("woff2");
            unicode-range: u+1f??;
        }
        ...
        @font-face {
            ...
            unicode-range: u+0370-+0384-038a, u+038c,
        ...
        @font-face {
            ...
            unicode-range: u111, u+0128-0129,
                u+0168-0169, u+01a0-01a1, u+01af-01b0, u+0300-0301,
                u+0303-0304, u+0308-0309, u+0323, u+0329, u u+20ab;
        }
        ...
        @font-face {
            ...
            unicode-range: u+00??, u+0131, u+0152-0153, u+02bb-02bc, u+02c6,
                ...
                u+20ac, u+2122, u+2191, u5, u+feff,
                u+fffd;
        }

        @font-face {
            font-display: swap;
            font-fam font-style: normal;
            font-weight: 200;
            src: url(https://fonts.gstatic.com/s/inter/v13/UcC73FwrK3iLTeHuS_fvQtMwCp50Kn                 format("woff2");
            ...
            u+2de0-2dff,
            u+a640-a69f,
            u+fe2e-fe2 @font-face {
                font-display: swap;
                font-family: Inter;
                font-style: normal;
                font-weig src: url(https://fonts.gstatic.com/s/inter/v13/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa0ZL7SUc.woff2) format("woff2");
                uniu+0400-045f,
                u+0490-0491,
                u+04b0-04b1,
                u+2116;
            ...
            @font-face {
                ...
                font-style: normal;
                font-weight: 200;
                src: url(https://fonts.gstatic.com/s/inter/v13/UcC73FwrK3iLTeHuS_f.woff2) format("woff2");
                unicode-range: u+1f??;
            }

            @font-face {
                font-display: font-family: Inter;
                font-style: normal;
                font-weight: 200;
                src: url(https://fonts.gst/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa1pL7SUc.woff2) format("woff2");
                unicode-range: u+0370-0377, u+037a-037f, u+0384-038a u+038e-03a1, u+03a3-03ff;
            }
            ...
            @font-face {
                ...
                tyle: normal;
                font-weight: 200;
                src: url(https://fonts.gstatic.com/s/inter/v13/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa2pL7SU         format("woff2");
                unicode-range: u+0102-0103, u+0110-0111, u+0128-0129,
                    u+0168-0169, u+01a0-01a1, u+01af- u+0303-0304, u+0308-0309, u+0323, u+0329, u+1ea0-1ef9,
                    u+20ab;
            }
            ...
            @font-face {
                font-display: swap;
                font-family: Inter;
                font-style: nor font-weight: 200;
                src: url(httom/s/inter/v13/UcC73FwrK3iLT5L7SUc.woff2) format("woff2");
                unicode-range: u+0100-02af, u+0304, u+0308, u+0329, u+1e00-1e9f,
                    u+1ef2-1eff, u+2020, u+20a0-20ab, u+20ad-20c0, u+2113,
                    u+2c60-2c7f, u+a720-a7ff;
            }
            ...
            @font-face {
                ...
                unicode-range: u+0301, u+0400-045f, u+0490-0491, u+04b0 u+2116;
            }

            @font-face {
                fon font-family: Inter;
                font-style: normal;
                font-weight: 300;
                src: url(https://fonts.gstatic.com/s/inter/v13/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa2ZL7SUc.woff2) off2");
 unicode-range: u+1f??;
            }

            font-display: swap;
            font-family: Inter;
            _nuxt font-style: normal;
            font-weight: 300;
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 600;
            src: url(https://fonts.gst_nuxtr/v13/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa25L7SUc.woff2) _nuxtormat("woff2");
            unicode-range: u+0100-02af, u+0304, _nuxt, u+1e00-1e9f,
                u+1ef2-1eff, u+2020, u+20a0-20ab, u+20ad-20c0, u+2113,
                u+2c60-2c7f, u+a720-a7ff;
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 600;
            src: url(https://fonts.gstatic.com/s/inteHuS_fvQtMwCp50KnMa1ZL7.woff2) format("woff2");
            unicode-range: u+00??, u+0131, u+0152-0153, u+02bb-02bc, u+02c6 u+02da, u+02dc, u+0304, u+0308, u+0329, u+2000-206f, u+2074,
                u+20ac, u+2122, u+2191, u+2193, u+2212, u+2215, u+feff,
        ...
        @font-face {
            font-display: swap;
            font-family: Inter;
            font-style: normalnt-weight: 700;
            src: url(https://fonts.gstatic.com/s/inter/v13/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa2JL7SUc.woff2) unicode-range: u+0460-052f, u+1c80-1c88, u+20b4, u+2de0-2dff,
                u+a640-a69f, u+fe2e-fe2f;
        }
    ...
    <link
        ...
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/avatarImage4.DjZKu00C.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/webp"
        href="./_nuxt/background.bQbQqYvm.webp" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/avatarImage1.BM-hvPBL.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/avatarImage2.CzfVkfy5.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/avatarImage3.CNGXgGVa.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/avatarImage5.B0Y4zME7.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/american-airlines-300x110.BPH4xp4l.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/delta-air-lines-300x110.DCiXAeIM.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/emirates-300x110.CXhLGX5X.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/lufthansa-300x110.DIpgDt8m.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/qatar-airways-300x110.CMMQeGrl.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/turkish-airlines-300x110.hQ_XXooA.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/united-airlines-300x110.BWjXKddI.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/american-airlines-100x100.Dg7Z4J4q.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/delta-air-lines-100x100.D8gp9wRy.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/emirates-100x100.C7kt6I3Z.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/lufthansa-100x100.DGnMgPdP.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/qatar-airways-100x100.M2hLNZnN.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/turkish-airlines-100x100.Cz6nBaUq.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/png"
        href="https://fly.business/_nuxt/united-airlines-100x100.DcexmH70.png" />
    <link
        rel="prefetch"
        as="image"
        type="image/webp"
        href="https://fly.business/_nuxt/welcome.C3L7V_v0.webp" />
    <link
        rel="prefetch"
        as="image"
        type="image/webp"
        href="https://fly.business/_nuxt/accreditation.1lz1GeTG.webp" />
    ...
    <link
        rel="icon"
        type="image/x-icon"
        href="https://fly.business/favicon/favicon.ico" />
    <link
        rel="apple-touch-icon-precomposed"
        sizes="57x57"
        href="https://fly.business/favicon/apple-touch-icon-57x57.png" />
    <link
        rel="apple-touch-icon-precomposed"
        sizes="114x114"
        href="https://fly.business/favicon/apple-touch-icon-114x114.png" />
    <link
        rel="apple-touch-icon-precomposed"
        sizes="72x72"
        href="https://fly.business/favicon/apple-touch-icon-72x72.png" />
    <link
        rel="apple-touch-icon-precomposed"
        sizes="144x144"
        href="https://fly.business/favicon/apple-touch-icon-144x144.png" />
    <link
        rel="apple-touch-icon-precomposed"
        sizes="60x60"
        href="https://fly.business/favicon/apple-touch-icon-60x60.png" />
    <link
        rel="apple-touch-icon-precomposed"
        sizes="120x120"
        href="https://fly.business/favicon/apple-touch-icon-120x120.png" />
    <link
        rel="apple-touch-icon-precomposed"
        sizes="76x76"
        href="https://fly.business/favicon/apple-touch-icon-76x76.png" />
    <link
        rel="apple-touch-icon-precomposed"
        sizes="57x57"
        href="https://fly.business/favicon/apple-touch-icon-152x152.png" />
    <link
        rel="icon"
        type="image/png"
        href="https://fly.business/favicon/favicon-196x196.png"
        sizes="196x196" />
    <link
        rel="icon"
        type="image/png"
        href="https://fly.business/favicon/favicon-96x96.png"
        sizes="96x96" />
    <link
        rel="icon"
        type="image/png"
        href="https://fly.business/favicon/favicon-32x32.png"
        sizes="32x32" />
    <link
        rel="icon"
        type="image/png"
        href="https://fly.business/favicon/favicon-16x16.png"
        sizes="16x16" />
    <link
        rel="icon"
        type="image/png"
        href="https://fly.business/favicon/favicon-128x128.png"
        sizes="128x128" />
    <meta property="og:url" content="https://fly.business/" />
    <meta
        property="og:image"
        content="https://fly.business/images/og-image.png" />
    <meta property="og:type" content="website" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta
        name="twitter:image"
        content="https://fly.business/images/og-image.png" />
    <link rel="canonical" href="https://fly.business/" />
    ...
    <style>
        ...
        .trust-wallet-one-tap .body {
            ...
            _nuxt .trust-wallet-one-tap .body .right-items {
                gap: 10px;
                width: 100%;
            }
    ...
    <link
        rel="stylesheet"
        crossorigin=""
        href="./_nuxt/WhyToBook.iolYF26h.css" />
   
    <link
        rel="stylesheet"
        href="./_nuxt/widget.css"
        class="jv-css" />
...
<body>
    ...
    <div id="__nuxt">
        ...
        <div>
                ...
                <div
                    ...
                    <div class="max-lg:hidden flex items-center gap-4">
                        ...
                        <div>
                            <svg
                                ...
                                width="3.5rem"
                                height="37"
                                viewbox="0 0 56 37" style="color:black">
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                                ...
                                <path
                                    ...
                                    fill="currentColor"></path>
                                <path
                                    d="M1.32704 31.1589H19.7207V33.4177H1.32704V31.1589Z"
                                    fill="currentColor"></path>
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                                    ...
                                    fill="currentColor"></path>
                                <path
                                    d="M25.6671 13.0506H28.0949V23.9625H25.6671V13.0506Z"
                                    fill="currentColor"></path>
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                                    ...
                                    fill="currentColor"></path>
                                <path
                                    d="M36.1508 13.0506H38.5786V23.9625H36.1508V13.0506Z"
                                    fill="currentColor"></path>
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                                    ...
                                    fill="currentColor"></path>
                                <path
                                    d="M46.5213 13.0506H48.9491V23.9625H46.5213V13.0506Z"
                                    fill="currentColor"></path>
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                        ...
                        <div
                            ...
                            <svg
                                ...
                                width="3.12em"
                                height="1em"
                                viewbox="0 0 78 25" style="color:black"
                                ...
                                <path
                                    ...
                                    fill="currentColor"></path>
                                <path
                                    d="M40.4298 6.61109V8.95767H36.9577V18.0494H34.5035V8.95767H31.0314V6.61109H40.4298Z"
                                    fill="currentColor"></path>
                                <path
                                ...
                                <path
                                    ...
                                    fill="currentColor"></path>
                                <path
                                    d="M19.0364 6.92563V9.27221H15.5643V18.3639H13.1101V9.27221H9.63805V6.92563H19.0364Z"
                                    fill="currentColor"></path>
                                <path
                                ...
                                <path
                                    ...
                                    fill="currentColor"></path>
                                <path
                                    d="M42.5614 21.6791V19.702H42.9897V21.6791H42.5614Z"
                                    fill="currentColor"></path>
                                <path
                                    d="M44.8795 19.697V20.1014H44.2798V21.6741H43.8565V20.1014H43.2568V19.697H44.8795Z"
                                    fill="currentColor"></path>
                                <path
                                ...
                                <path
                                    ...
                                    fill="currentColor"></path>
                                <path
                                    d="M51.1534 19.697V20.1014H50.5537V21.6741H50.1304V20.1014H49.5308V19.697H51.1534Z"
                                    fill="currentColor"></path>
                                <path
                                ...
                                <path
                                    ...
                                    fill="currentColor"></path>
                                <path
                                    d="M59.5691 19.697V21.2697H60.587V21.6741H59.1408V19.697H59.5691Z"
                                    fill="currentColor"></path>
                                <path
                            ...
                            <svg
                                ...
                                <g clip-path="url(#clip0_3169_761)">
                                    ...
                                    <path
                                        ...
                                        fill="currentColor"></path>
                                    <path
                                        d="M13.6979 12.2629L13.2202 10.8201L9.78345 13.2529L13.6979 12.2629Z"
                                        fill="currentColor"></path>
                                </g>
                                <defs>
                                    <clippath id="clip0_3169_761">
                                        <rect
                                            ...
                                            height="18"
                                            fill="currentColor"
                                            transform="translate(0.78125 0.5)"></rect>
                                    </clippath>
                                </defs>
                            </svg>
                        </div>
                    ...
                    <div class="flex items-center gap-6">
                        <a
                            ...
                            href="tel:+18776571177"><span class="text-sm font-bold">FREE PHONE-ONLY DEALS</span><span class="flex items-center gap-1"><span
                                    class="iconify i-ic:baseline-phone"
                                    aria-hidden="true"
                                    style=""></span><span class="text-xs font-medium">Call 24/7: +1 (315) 260-2111</span></span>
                            <div
                                class="absolute top-1/2 left-1/2 w-2/3 h-full -translate-x-1/2 -translate-y-1/2 before:absolute before:inset-0 before:rounded-full before:bg-brand before:animate-ping -z-10"></div>
                        </a><!--[--><button
                            type="button"
                            ...
                            class="">
                            <!--[--><span
                                class="iconify i-jam:menu text-4xl"
                                aria-hidden="true"
                                style=""></span><!--]--></button><!--]-->
                    </div>
                </div>
            ...
            <main class="[--header-height:5rem] md:[--header-height:8rem]">
                <!--[-->
                <section
                    class="relative min-h-svh pb-10 lg:pb-16 flex flex-col items-center justify-center backdrop-blur-lg pt-[--header-height]">
                    <img
                        src="./_nuxt/background.bQbQqYvm.webp"
                        alt=""
                        loading="lazy"
                        class="absolute top-0 -z-[1] w-full h-full object-cover" />
                    <div
                        class="absolute inset-0 backdrop-blur-xl -z-[1]"
                        aria-hidden="true"></div>
                    <div
                        class="container flex flex-col gap-3 xl:gap-6 items-center justify-center">
                        <div class="flex flex-col items-center gap-3">
                            <div
                                class="text-2xl sm:text-4xl text-white text-center">
                                Excellent choice,
                                <span class="font-semibold">412343!</span>
                            </div>
                            <div
                                class="px-2 py-1 sm:px-6 sm:py-3 bg-white rounded sm:rounded-xl sm:text-xl text-center">
                                Welcome on board! An agent will contact you
                                shortly
                            </div>
                        </div>
                        <div
                            class="flex flex-col items-center gap-2 text-white sm:text-2xl text-center">
                            <div class="font-semibold">
                                If you cannot wait please call us
                            </div>
                            <a href="tel:+18776571177">+1 (315) 260-2111</a </div>
                            <div
                                class="max-sm:mt-auto flex flex-col gap-3 pt-4 border-t">
                               
                                <div
                                    class="flex items-center justify-center gap-3 text-center">
                                    <span
                                        class="max-sm:hidden text-sm text-white">Call us to lock in your low fare right
                                        now</span><a
                                        href="tel:+18776571177"
                                        class="p-2 text-sm bg-green-100 text-green-800 font-semibold rounded">+1 (315) 260-2111</a>
                                </div>
                            </div>
                        </div>
                </section>
            ...
            <footer class="flex flex-col gap-6 pt-10 bg-[#F6FBFF]">
                <div class="container flex gap-6 max-xl:flex-col">
                    <div class="flex gap-6 flex-col shrink-0">
                        <div
                            class="flex items-center justify-between gap-1 p-3 bg-white">
                            <a href="/" class="">
                            <img src="/logo.png" style="width:100%;max-width:160px" alt=""></a>
                            <div
                                class="relative isolate mb-1.5 mr-1.5 group">
                                <span
                                    aria-hidden="true"
                                    ...
                                    href="tel:+18776571177"
                                    class="flex flex-col items-center px-3 py-1 text-sm tracking-wider bg-brand hover:bg-brand-700 transition-colors text-white rounded"><span class="font-bold">FREE PHONE-ONLY DEALS</span><span>+1 (315) 260-2111</span></a>
                            </div>
                        </div>
                        <div
                            class="flex max-sm:flex-col max-sm:items-center justify-between gap-2">
                            <div class="flex flex-col">
                                <div>Follow us on Social Media:</div>
                                <div
                                    class="flex max-sm:justify-center gap-2 text-2xl">
                                    <a
                                        target="_blank"
                                        href="https://www.instagram.com/flybusiness360"
                                        aria-label="Fly Business Instagram page"
                                        class="hover:text-brand"><span
                                            class="iconify i-simple-icons:instagram"
                                            aria-hidden="true"
                                            style=""></span></a><a
                                        target="_blank"
                                        href="https://www.facebook.com/flybusiness360"
                                        aria-label="Fly Business Facebook page"
                                        class="hover:text-brand"><span
                                            class="iconify i-simple-icons:facebook"
                                            aria-hidden="true"
                                            style=""></span></a>
                                </div>
                            </div>
                            <div class="flex flex-col max-sm:items-center">
                                ...
                                <div
                                    class="flex max-sm:gap-3 sm:gap-2 text-brand">
                                    <a
                                        href="tel:+18775133776"
                                        class="group relative isolate w-fit">+1 (315) 260-2111
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="mailto:cs@fly.business"
                                        class="group relative isolate w-fit">cs@fly.business
                                        <span
                                            aria-hidden="true"
                        ...
                        <nav class="max-md:hidden grid grid-cols-4 gap-5">
                            ...
                            <div class="flex flex-col gap-2.5">
                                ...
                                <div class="flex flex-col gap-2">
                                    <!--[--><a
                                        href="/"
                                        class="group relative isolate w-fit">Europe
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Asia
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Africa
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Oceania
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Middle East
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Latin America
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Indian Subcontinent
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]-->
                                </div>
                            ...
                            <div class="flex flex-col gap-2.5">
                                ...
                                <div class="flex flex-col gap-2">
                                    <!--[--><a
                                        href="/"
                                        class="group relative isolate w-fit">United Kingdom
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Japan
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Tanzania
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">New Zealand
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Qatar
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Brazil
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Maldives
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]-->
                                </div>
                            ...
                            <div class="flex flex-col gap-2.5">
                                ...
                                <div class="flex flex-col gap-2">
                                    <!--[--><a
                                        href="/"
                                        class="group relative isolate w-fit">Paris
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Beijing
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Cape Town
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Sydney
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Dubai
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Buenos Aires
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Seoul
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]-->
                                </div>
                            ...
                            <div class="flex flex-col gap-2.5">
                                ...
                                <div class="flex flex-col gap-2">
                                    <!--[--><a
                                        href="/"
                                        class="group relative isolate w-fit">American Airlines
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Turkish Airlines
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">United Airlines
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Delta Air Lines
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Qatar Airways
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Lufthansa
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><a
                                        href="/"
                                        class="group relative isolate w-fit">Emirates
                                        <span
                                            aria-hidden="true"
                                            class="absolute top-full left-0 w-full h-px bg-current scale-x-0 group-hover:scale-x-100 transition origin-left"></span></a><!--]-->
                                </div>
                        ...
                        <nav class="md:hidden flex flex-col gap-3.5">
                            ...
                            <div
                                ...
                                <!--[--><!--[--><button
                                    ...
                                    aria-expanded="false"
                                    data-state="closed"
                                    id="radix-vue-accordion-trigger-v-0-3-0"
                                    data-radix-vue-collection-item=""
                                    data-orientation="vertical"
                                    class="group w-full flex items-center justify-center gap-1.5 uppercase font-semibold">
                                    <!--[--><!--[-->Top Regions
                                    <span
                                ...
                                <div
                                    role="region"
                                    hidden=""
                                    aria-labelledby="radix-vue-accordion-trigger-v-0-3-0"
                                    data-state="closed"
                                    data-orientation="vertical"
                                    style="
                                    ...
                                    id="radix-vue-collapsible-content-v-0-3-1">
                                    <!---->
                                </div>
                                <!--]--><!--]-->
                            </div>
                            <div
                                ...
                                <!--[--><!--[--><button
                                    ...
                                    aria-expanded="false"
                                    data-state="closed"
                                    id="radix-vue-accordion-trigger-v-0-3-2"
                                    data-radix-vue-collection-item=""
                                    data-orientation="vertical"
                                    class="group w-full flex items-center justify-center gap-1.5 uppercase font-semibold">
                                    <!--[--><!--[-->Top Countries
                                ...
                                role="region"
                                hidden=""
                                aria-labelledby="radix-vue-accordion-trigger-v-0-3-2"
                                data-state="closed"
                                data-orientation="vertical"
                                style="
                                --radix-accordion-content-width: var(
                                ...
                                "
                                class="accordion-content flex flex-col items-center gap-2 pt-2.5"
                                id="radix-vue-collapsible-content-v-0-3-3"
                                >
                                <!---->
                            </div>
                            <!--]--><!--]-->
                    ...
                    <div
                        ...
                        <!--[--><!--[--><button
                            ...
                            aria-expanded="false"
                            data-state="closed"
                            id="radix-vue-accordion-trigger-v-0-3-4"
                            data-radix-vue-collection-item=""
                            data-orientation="vertical"
                            class="group w-full flex items-center justify-center gap-1.5 uppercase font-semibold">
                            <!--[--><!--[-->Top Cities
                        ...
                        <div
                            role="region"
                            hidden=""
                            aria-labelledby="radix-vue-accordion-trigger-v-0-3-4"
                            data-state="closed"
                            data-orientation="vertical"
                            style="
                                            --radix-accordion-content-width: var(
                                        ...
                                        "
                            class="accordion-content flex flex-col items-center gap-2 pt-2.5"
                            id="radix-vue-collapsible-content-v-0-3-5">
                            <!---->
                        </div>
                        <!--]--><!--]-->
                    </div>
                    <div
                        ...
                        <!--[--><!--[--><button
                            ...
                            aria-expanded="false"
                            data-state="closed"
                            id="radix-vue-accordion-trigger-v-0-3-6"
                            data-radix-vue-collection-item=""
                            data-orientation="vertical"
                            class="group w-full flex items-center justify-center gap-1.5 uppercase font-semibold">
                            <!--[--><!--[-->Top Airlines
                        ...
                        <div
                            role="region"
                            hidden=""
                            aria-labelledby="radix-vue-accordion-trigger-v-0-3-6"
                            data-state="closed"
                            data-orientation="vertical"
                            style="
                                            --radix-accordion-content-width: var(
                                        ...
                                        "
                            class="accordion-content flex flex-col items-center gap-2 pt-2.5"
                            id="radix-vue-collapsible-content-v-0-3-7">
                            <!---->
                        </div>
                        <!--]--><!--]-->
                    </div>
                ...
                <div class="flex flex-col gap-3">
                    <div class="text-xs text-gray-500">
                        *"Best Price to Your Destination" or promotional
                        Deals advertised on our website represent a
                        range of very restrictive fares that can be
                        purchased only, and only if all and any rules
                        and conditions are met. For the business class
                        conditions, please, consider the range of
                        limitations specified below:<br />
                        • Airfare based on weekday travel Monday through
                        Thursday only. • The advertised price shown on
                        the website represents the price per adult in
                        USD currency, with all the taxes, fees and any
                        extra surcharges included. • The prices are
                        subject to seat availability, therefore, those
                        may change any time as per the seats being sold
                        out or inventory limitations implied by a
                        specific airline taking place. • Most of the
                        heavily discounted fares are non-refundable.
                        Free exchange can be granted if approved by the
                        partner airlines. Standard fare rules apply for
                        your bookings, feel free to request additional
                        information with your personal travel agent. You
                        may also request a quote for a less restrictive
                        fare based on your preferences. • Important
                        Notice: the advertised fare is subject to change
                        without any prior notice. • Min Stay - Saturday
                        Night. • Maximum stay - 6 days. • The Best Price
                        to Your Destination is available for the flights
                        between Nov 25, 2025 till Dec 5, 2025 •
                        Individual Travel Only is allowed, no group
                        travel fares will be granted. • The offered Best
                        Price to Your Destination offers must be
                        purchased the same day only. Origin cities and
                        destination areas combinations subject for Best
                        Price to Your Destination are:• SEA - Europe •
                        LAX - Australia • DTW - Asia • PHL - Africa •
                        BOS - ISC <br /><br />
                        ** Arrival date is an estimate. Please consult
                        with your agent for details.
                    </div>
                    <div
                        class="flex flex-wrap items-center justify-center gap-3 text-gray-300 my-auto">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="68"
                            height="23"
                            ...
                            <defs>
                                <clippath id="clip0_3527_1430">
                                    <rect
                                        ...
                                        height="36"
                                        fill="white"
                                        transform="translate(0.166878 0.5)"></rect>
                                </clippath>
                            </defs>
                        </svg><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="61"
                            height="23"
                            viewbox="0 0 61 23" style="color:black">
                            <path
                            ...
                            <path
                                ...
                                fill="currentColor"></path>
                            <path
                                d="M34.976 8.75983H33.1764V1.70647H34.976V8.75983Z"
                                fill="currentColor"></path>
                            <path
                            ...
                            <path
                                d="M14.7591 0.809258H12.1975V14.0342H14.7591V0.809258Z"></path>
                            <path
                            ...
                            <path
                                d="M56.6845 9.71324L53.1982 0.809258H50.3793L55.9649 14.3974H57.3519L63.0382 0.809258H60.2715L56.6845 9.71324Z"></path>
                            <path
                                d="M64.2165 14.0342H71.4949V11.8213H66.7818V8.21926H71.342V5.95395H66.7818V3.02215H71.4949V0.809258H64.2165V14.0342Z"></path>
                            <path
                            ...
                            <path
                                d="M43.9728 14.4963C47.8216 14.4963 50.9417 11.3631 50.9417 7.49813C50.9417 3.63317 47.8216 0.5 43.9728 0.5C40.124 0.5 37.0039 3.63317 37.0039 7.49813C37.0039 11.3631 40.124 14.4963 43.9728 14.4963Z"></path>
                            <path
                                d="M43.9728 14.5C47.8208 14.5 50.9417 11.366 50.9417 7.50187C50.9417 3.63774 47.8245 0.5 43.9728 0.5C40.1211 0.5 37.0039 3.63399 37.0039 7.49813C37.0039 11.3623 40.1248 14.5 43.9728 14.5Z"></path>
                            <path
                            ...
                            target="_blank"
                            href="https://www.trustpilot.com/review/fly.business"
                            class="hover:text-gray-500"><svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="73"
                                height="19"
                                viewbox="0 0 73 19" style="color:black">
                            ...
                            class="flex gap-2 hover:text-gray-500"><svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="3.12em"
                                height="1em"
                                viewbox="0 0 78 25" style="color:black">
                            ...
                            <div class="flex flex-col text-xs">
                                <span style="color:black">TRUE Code:</span><span style="color:black">99931160</span>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div
            class="flex max-sm:flex-col items-center justify-center gap-2.5 p-5 bg-brand text-white">
            <div class="text-sm">
                © Fly Business, 2025. All rights reserved.
            </div>
            <div
    ...
    <button
        ...
        <span
            class="iconify i-tabler:message shrink-0 text-2xl sm:text-lg"
            aria-hidden="true"></span><span class="max-sm:hidden">LIVE CHAT</span></button><!----><!--]-->
    </div>
